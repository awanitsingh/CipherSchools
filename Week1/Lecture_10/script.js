...
let person3 = new person("Awanit","Singh");
let person2 = new person("Abhay","Kumar");
...
let person5 = new  Person("Awanit", 24);
...
let person6 = new  Person("Awanit", "Shubham");
...
let person1 = new  Person("Awanit", "Shubham");

console.log(perosn1.firstName);
console.log(person1.getDetails_NoAccess());

let studemt1 = new Student("Abhay","Kumar", 20);
